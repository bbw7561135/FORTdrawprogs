...
!     #                Carr(NC_ex)/-1.00,-0.25,-0.05,0.05,0.25,one/,
     ...
     #                Ratioea(NC)/NC*zero/
      ...
      endSELECT
         ...
         fnen=Out//'spectra/'//Sp//SA//'sp'//fln(1)//NTn(1)//ext
         fnea=Out//'spectra/'//Sp//SA//'sp'//fln(1)//NTn(2)//ext
         fnmn=Out//'spectra/'//Sp//SA//'sp'//fln(2)//NTn(1)//ext
         fnma=Out//'spectra/'//Sp//SA//'sp'//fln(2)//NTn(2)//ext
      ...
      endDO
         ...
         fnen=Out//'spectra/'//Sp//SA//'za'//fln(1)//NTn(1)//ext
         fnea=Out//'spectra/'//Sp//SA//'za'//fln(1)//NTn(2)//ext
         fnmn=Out//'spectra/'//Sp//SA//'za'//fln(2)//NTn(1)//ext
         fnma=Out//'spectra/'//Sp//SA//'za'//fln(2)//NTn(2)//ext
...
!  101 FORMAT(3(1PE16.8))
  ...
  102 FORMAT(101(1PE16.8))
         ...
         STOP 'THE END OF PROGRAM spHonda'
      END PROGRAM sphonda
