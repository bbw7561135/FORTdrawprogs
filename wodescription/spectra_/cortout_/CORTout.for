...
c                                                                      c
      ...
      CHARACTER*43 Out/'/home/redponick/phd/fortran/Output/CORTout/'/
      LOGICAL*2    Test/.True./          ! Default value is .False.
      LOGICAL*2    Res /.True./          ! Default value is .False.
...
*     ==================================================================
         ...
         IF (cosZA.LT.-1.0D0.OR.cosZA.GT.1.0D0) THEN
