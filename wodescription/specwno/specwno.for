...
************************************************************************
     ...
     #                hin(2)/'n','i'/
                 REAL
     #                E(NE),
     #                Resen(NE),Resea(NE),Resmn(NE),Resma(NE),
     #                start_time,finish_time,time
         ...
         EXTERNAL underint,uifen,uifea,uifmn,uifma
...
!         CALL GeMInf
         ...
         STOP 'THE END OF PROGRAM specwno'

   99    STOP 'ERROR WITH GeMSet in specwno'
  100    STOP 'ERROR WITH GeMInt in specwno'
