************************************************************************
      FUNCTION FunsGeM(var)
************************************************************************
*                                                                      *
*                                     ITEP, Moscow, Russia, 2010/02/10 *
*                                 BLTP JINR, Dubna, Russia, 2013/09/27 *
************************************************************************
...
*     ================================================================ *
      ENTRY GeM_Q2d2sDISCC_dQ2dnu(var)
*     ================================================================ *
         W2= dW2*var(1)+W2_min
...
*     ================================================================ *
      ENTRY GeM_d2sDISCC_dQ2dnu(var)
*     ================================================================ *
         W2= dW2*var(1)+W2_min
         CALL Q2DIS_lim(E_nu,W2,Q2_min,Q2_max)
         IF (Q2_min.ge.Q2_max) THEN
           GeM_d2sDISCC_dQ2dnu= zero
                               ELSE
           Q2= (Q2_max-Q2_min)*var(2)+Q2_min                             Square of mometum transfer (Q^2=-q^2)
           x = Q2/(Q2+W2-mm_ini)
           CALL xDIS_lim(E_nu,x_min,x_max)
           IF (x.le.x_min .or. x.ge.x_max) THEN
             ...
             IF (y.le.y_min .or. y.ge.y_max) THEN
               GeM_d2sDISCC_dQ2dnu= zero
                                             ELSE
               GeM_d2sDISCC_dQ2dnu=(Q2_max-Q2_min)/(2*m_ini*y*E_nu**2)*
