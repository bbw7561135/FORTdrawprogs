************************************************************************
      SUBROUTINE NuclStructFuns(E_nu,x_B,Q2,F1,F2,F3,F4,F5,F6)
************************************************************************
*                                                                      *
*                                                                      *
*     REFERENCES                                                       *
...
************************************************************************
     ...
     #        C2_val        = 0.485,
     #        C_sea         = 0.381,
     #        g2_0LRp       = ( 0.5-2*sin2W/3)**2+(-2*sin2W/3)**2,       g ^2_L + g ^2_R
     #        g2_1LRp       = (-0.5+1*sin2W/3)**2+( 1*sin2W/3)**2,       g'^2_L + g'^2_R
     #        g2_0LRm       = ( 0.5-2*sin2W/3)**2-(-2*sin2W/3)**2,       g ^2_L - g ^2_R
     #        g2_1LRm       = (-0.5+1*sin2W/3)**2-( 1*sin2W/3)**2,       g'^2_L - g'^2_R
...
*     ==================================================================
      ENTRY SFCC(E_nu,x_B,Q2,F1,F2,F3,F4,F5,F6)                          x_Bjorken
*     ==================================================================
         IF (n_Qc_DIS.eq.0 .and. Q2.lt.Q2_DIS) THEN
           x_r= x_B*Q2_DIS/Q2                                            x rescaling
           x_0= 2*x_r/(1+sqrt(1+4*mm_ini*x_r**2/Q2))                     x Nachtmann+rescaling
                                               ELSE
           x_0= 2*x_B/(1+sqrt(1+4*mm_ini*x_B**2/Q2))                     x Nachtmann
      endIF
         x_c= x_0*(1+mm_c/Q2)                                            x Feynman

         SELECTCASE(n_AG_DIS)
*              ======================================================= *
               CASE(       0)                                            E.A. Paschos and J.Y. Yu, Ref. [1]
*              ======================================================= *
...
*              ------------------------------------------------------- *
*              ======================================================= *
               CASE(       1)                                            K.S. Kuzmin and V.A. Naumov, Ref.[2]
*              ======================================================= *
*              ------------------------------------------------------- *
*              NON-CHARM PRODUCTION COMPONENTS                         *
*              ------------------------------------------------------- *
...
*              ------------------------------------------------------- *
     ...
     #                               (Dq_0*s2C+Cq_0*c2C-(Sa_c-Sa_0)*c2C)
              ...
              endSELECT
                 ...
                 SELECTCASE(n_Rc_DIS)
                       CASE(       0); FL_c= F0_L(E_nu,x_0,    Q2,F2_c)
                       CASE(       1); FL_c= Fc_L(E_nu,x_0,x_c,Q2,F2_c)
              endSELECT
...
*              ------------------------------------------------------- *
*              ======================================================= *
               CASE(       2)                                            A. Bodek and U.K. Yang, Ref. [3]
*              ======================================================= *
...
*              ------------------------------------------------------- *
*              ======================================================= *
               CASE(       3)                                            V.A. Naumov's "1-2" scheme, Ref. [4]
*              ======================================================= *
*              ------------------------------------------------------- *
*              NON-CHARM PRODUCTION COMPONENTS                         *
*              ------------------------------------------------------- *
...
*              ------------------------------------------------------- *
     ...
     #                               (Dq_0*s2C+Cq_0*c2C-(Sa_c-Sa_0)*c2C)
              ...
              endSELECT
                 SELECTCASE(n_Rc_DIS)
                       CASE(       0); R= R0(E_nu,x_0,    Q2)
                       CASE(       1); R= Rc(E_nu,x_0,x_c,Q2)
              endSELECT
...
*              ------------------------------------------------------- *
*              ======================================================= *
               CASE(       5)                                            V.A. Naumov's "QCD" scheme, Ref. [4]
*              ======================================================= *
*              ------------------------------------------------------- *
*              NON-CHARM PRODUCTION COMPONENTS                         *
*              ------------------------------------------------------- *
...
*              ------------------------------------------------------- *
*              ======================================================= *
               CASE(       6)                                            V.A. Naumov's test scheme, Ref. [4]
*              ======================================================= *
*              ------------------------------------------------------- *
*              NON-CHARM PRODUCTION COMPONENTS                         *
*              ------------------------------------------------------- *
